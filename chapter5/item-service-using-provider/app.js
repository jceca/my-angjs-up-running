/**
 * Created by Javier on 29/01/2015.
 */
...
angular.module('notesApp', [])
    .provider('ItemService', function () {
        ...
        this.disabledDefaultItems = function () {
            haveDefaultItems = false;
        };

        // This function gets our dependencies, not the proveder above
        this.$get = [function() {
            var optItems = [];
            if (haveDefaultItems) {
                optItems = [
        ...
        function(ItemServiceProvider) {
            ...
            * running the example */
            ...
            if (!shouldHaveDefaults) {
                ItemServiceProvider.disabledDefaultItems();
            }
        }])
